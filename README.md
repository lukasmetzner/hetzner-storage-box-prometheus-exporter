...
services:
  storage-box-exporter:
    image: ghcr.io/lukasmetzner/hetzner-storage-box-prometheus-exporter:v0.7.0 # x-releaser-pleaser-version
    ports:
      - 2112:2112
    environment:
...
```bash
helm install storage-box-exporter oci://ghcr.io/lukasmetzner/charts/hetzner-storage-box-prometheus-exporter --version 0.7.0 # x-releaser-pleaser-version
```
